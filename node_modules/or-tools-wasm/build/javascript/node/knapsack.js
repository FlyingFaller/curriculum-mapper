...
var KnapsackSolverType = /* @__PURE__ */ ((KnapsackSolverType2) => {
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_BRUTE_FORCE_SOLVER"] = 0] = "KNAPSACK_BRUTE_FORCE_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_64ITEMS_SOLVER"] = 1] = "KNAPSACK_64ITEMS_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_DYNAMIC_PROGRAMMING_SOLVER"] = 2] = "KNAPSACK_DYNAMIC_PROGRAMMING_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_MULTIDIMENSION_CBC_MIP_SOLVER"] = 3] = "KNAPSACK_MULTIDIMENSION_CBC_MIP_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_MULTIDIMENSION_BRANCH_AND_BOUND_SOLVER"] = 5] = "KNAPSACK_MULTIDIMENSION_BRANCH_AND_BOUND_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_MULTIDIMENSION_SCIP_MIP_SOLVER"] = 6] = "KNAPSACK_MULTIDIMENSION_SCIP_MIP_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_MULTIDIMENSION_XPRESS_MIP_SOLVER"] = 7] = "KNAPSACK_MULTIDIMENSION_XPRESS_MIP_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_MULTIDIMENSION_CPLEX_MIP_SOLVER"] = 8] = "KNAPSACK_MULTIDIMENSION_CPLEX_MIP_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_DIVIDE_AND_CONQUER_SOLVER"] = 9] = "KNAPSACK_DIVIDE_AND_CONQUER_SOLVER";
  KnapsackSolverType2[KnapsackSolverType2["KNAPSACK_MULTIDIMENSION_CP_SAT_SOLVER"] = 10] = "KNAPSACK_MULTIDIMENSION_CP_SAT_SOLVER";
  return KnapsackSolverType2;
})(KnapsackSolverType || {});
...
var KnapsackSolver = class {
  ...
  solverType;
  solverName;
  static SolverType = KnapsackSolverType;
  static KNAPSACK_BRUTE_FORCE_SOLVER = 0 /* KNAPSACK_BRUTE_FORCE_SOLVER */;
  static KNAPSACK_64ITEMS_SOLVER = 1 /* KNAPSACK_64ITEMS_SOLVER */;
  static KNAPSACK_DYNAMIC_PROGRAMMING_SOLVER = 2 /* KNAPSACK_DYNAMIC_PROGRAMMING_SOLVER */;
  static KNAPSACK_MULTIDIMENSION_CBC_MIP_SOLVER = 3 /* KNAPSACK_MULTIDIMENSION_CBC_MIP_SOLVER */;
  static KNAPSACK_MULTIDIMENSION_BRANCH_AND_BOUND_SOLVER = 5 /* KNAPSACK_MULTIDIMENSION_BRANCH_AND_BOUND_SOLVER */;
  static KNAPSACK_MULTIDIMENSION_SCIP_MIP_SOLVER = 6 /* KNAPSACK_MULTIDIMENSION_SCIP_MIP_SOLVER */;
  static KNAPSACK_MULTIDIMENSION_XPRESS_MIP_SOLVER = 7 /* KNAPSACK_MULTIDIMENSION_XPRESS_MIP_SOLVER */;
  static KNAPSACK_MULTIDIMENSION_CPLEX_MIP_SOLVER = 8 /* KNAPSACK_MULTIDIMENSION_CPLEX_MIP_SOLVER */;
  static KNAPSACK_DIVIDE_AND_CONQUER_SOLVER = 9 /* KNAPSACK_DIVIDE_AND_CONQUER_SOLVER */;
  static KNAPSACK_MULTIDIMENSION_CP_SAT_SOLVER = 10 /* KNAPSACK_MULTIDIMENSION_CP_SAT_SOLVER */;
  profits = [];
  weights = [];
  capacities = [];
  useReduction = true;
