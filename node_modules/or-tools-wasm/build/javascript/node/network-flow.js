...
var SimpleMaxFlowStatus = /* @__PURE__ */ ((SimpleMaxFlowStatus2) => {
  SimpleMaxFlowStatus2[SimpleMaxFlowStatus2["OPTIMAL"] = 0] = "OPTIMAL";
  SimpleMaxFlowStatus2[SimpleMaxFlowStatus2["POSSIBLE_OVERFLOW"] = 1] = "POSSIBLE_OVERFLOW";
  SimpleMaxFlowStatus2[SimpleMaxFlowStatus2["BAD_INPUT"] = 2] = "BAD_INPUT";
  SimpleMaxFlowStatus2[SimpleMaxFlowStatus2["BAD_RESULT"] = 3] = "BAD_RESULT";
  return SimpleMaxFlowStatus2;
})(SimpleMaxFlowStatus || {});
var SimpleMinCostFlowStatus = /* @__PURE__ */ ((SimpleMinCostFlowStatus2) => {
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["NOT_SOLVED"] = 0] = "NOT_SOLVED";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["OPTIMAL"] = 1] = "OPTIMAL";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["FEASIBLE"] = 2] = "FEASIBLE";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["INFEASIBLE"] = 3] = "INFEASIBLE";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["UNBALANCED"] = 4] = "UNBALANCED";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["BAD_RESULT"] = 5] = "BAD_RESULT";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["BAD_COST_RANGE"] = 6] = "BAD_COST_RANGE";
  SimpleMinCostFlowStatus2[SimpleMinCostFlowStatus2["BAD_CAPACITY_RANGE"] = 7] = "BAD_CAPACITY_RANGE";
  return SimpleMinCostFlowStatus2;
})(SimpleMinCostFlowStatus || {});
var SimpleLinearSumAssignmentStatus = /* @__PURE__ */ ((SimpleLinearSumAssignmentStatus2) => {
  SimpleLinearSumAssignmentStatus2[SimpleLinearSumAssignmentStatus2["OPTIMAL"] = 0] = "OPTIMAL";
  SimpleLinearSumAssignmentStatus2[SimpleLinearSumAssignmentStatus2["INFEASIBLE"] = 1] = "INFEASIBLE";
  SimpleLinearSumAssignmentStatus2[SimpleLinearSumAssignmentStatus2["POSSIBLE_OVERFLOW"] = 2] = "POSSIBLE_OVERFLOW";
  return SimpleLinearSumAssignmentStatus2;
})(SimpleLinearSumAssignmentStatus || {});
var SimpleMaxFlow = class {
  static OPTIMAL = 0 /* OPTIMAL */;
  static POSSIBLE_OVERFLOW = 1 /* POSSIBLE_OVERFLOW */;
  static BAD_INPUT = 2 /* BAD_INPUT */;
  static BAD_RESULT = 3 /* BAD_RESULT */;
  tails = [];
  heads = [];
  capacities = [];
  result = null;
...
var SimpleMinCostFlow = class {
  static NOT_SOLVED = 0 /* NOT_SOLVED */;
  static OPTIMAL = 1 /* OPTIMAL */;
  static FEASIBLE = 2 /* FEASIBLE */;
  static INFEASIBLE = 3 /* INFEASIBLE */;
  static UNBALANCED = 4 /* UNBALANCED */;
  static BAD_RESULT = 5 /* BAD_RESULT */;
  static BAD_COST_RANGE = 6 /* BAD_COST_RANGE */;
  static BAD_CAPACITY_RANGE = 7 /* BAD_CAPACITY_RANGE */;
  tails = [];
  heads = [];
  capacities = [];
  unitCosts = [];
  ...
  add_arcs_with_capacity_and_unit_cost(tails, heads, capacities, unitCosts) {
    ...
    return tailValues.map((tail, index) => this.add_arc_with_capacity_and_unit_cost(tail, headValues[index], capacityValues[index], unitCostValues[index]));
  }
...
var SimpleLinearSumAssignment = class {
  static OPTIMAL = 0 /* OPTIMAL */;
  static INFEASIBLE = 1 /* INFEASIBLE */;
  static POSSIBLE_OVERFLOW = 2 /* POSSIBLE_OVERFLOW */;
  leftNodes = [];
  rightNodes = [];
  costs = [];
  result = null;
