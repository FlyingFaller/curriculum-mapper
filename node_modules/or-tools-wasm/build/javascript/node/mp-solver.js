...
var mpSolverModulePromise = null;
var mpSolverModule = null;
var mpSolverExports = null;
...
var linearSolverSchemasPromise = null;
var linearSolverRootPromise = null;
var mpModelTypePromise = null;
var mpModelRequestTypePromise = null;
var mpSolutionResponseTypePromise = null;
...
var OptimizationProblemType = /* @__PURE__ */ ((OptimizationProblemType2) => {
  OptimizationProblemType2[OptimizationProblemType2["CLP_LINEAR_PROGRAMMING"] = 0] = "CLP_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["GLPK_LINEAR_PROGRAMMING"] = 1] = "GLPK_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["GLOP_LINEAR_PROGRAMMING"] = 2] = "GLOP_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["PDLP_LINEAR_PROGRAMMING"] = 8] = "PDLP_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["HIGHS_LINEAR_PROGRAMMING"] = 15] = "HIGHS_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["SCIP_MIXED_INTEGER_PROGRAMMING"] = 3] = "SCIP_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["GLPK_MIXED_INTEGER_PROGRAMMING"] = 4] = "GLPK_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["CBC_MIXED_INTEGER_PROGRAMMING"] = 5] = "CBC_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["HIGHS_MIXED_INTEGER_PROGRAMMING"] = 16] = "HIGHS_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["GUROBI_LINEAR_PROGRAMMING"] = 6] = "GUROBI_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["GUROBI_MIXED_INTEGER_PROGRAMMING"] = 7] = "GUROBI_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["CPLEX_LINEAR_PROGRAMMING"] = 10] = "CPLEX_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["CPLEX_MIXED_INTEGER_PROGRAMMING"] = 11] = "CPLEX_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["XPRESS_LINEAR_PROGRAMMING"] = 101] = "XPRESS_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["XPRESS_MIXED_INTEGER_PROGRAMMING"] = 102] = "XPRESS_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["COPT_LINEAR_PROGRAMMING"] = 103] = "COPT_LINEAR_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["COPT_MIXED_INTEGER_PROGRAMMING"] = 104] = "COPT_MIXED_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["BOP_INTEGER_PROGRAMMING"] = 12] = "BOP_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["SAT_INTEGER_PROGRAMMING"] = 14] = "SAT_INTEGER_PROGRAMMING";
  OptimizationProblemType2[OptimizationProblemType2["KNAPSACK_MIXED_INTEGER_PROGRAMMING"] = 13] = "KNAPSACK_MIXED_INTEGER_PROGRAMMING";
  return OptimizationProblemType2;
})(OptimizationProblemType || {});
var MPSolverResultStatus = /* @__PURE__ */ ((MPSolverResultStatus2) => {
  MPSolverResultStatus2[MPSolverResultStatus2["OPTIMAL"] = 0] = "OPTIMAL";
  MPSolverResultStatus2[MPSolverResultStatus2["FEASIBLE"] = 1] = "FEASIBLE";
  MPSolverResultStatus2[MPSolverResultStatus2["INFEASIBLE"] = 2] = "INFEASIBLE";
  MPSolverResultStatus2[MPSolverResultStatus2["UNBOUNDED"] = 3] = "UNBOUNDED";
  MPSolverResultStatus2[MPSolverResultStatus2["ABNORMAL"] = 4] = "ABNORMAL";
  MPSolverResultStatus2[MPSolverResultStatus2["MODEL_INVALID"] = 5] = "MODEL_INVALID";
  MPSolverResultStatus2[MPSolverResultStatus2["NOT_SOLVED"] = 6] = "NOT_SOLVED";
  return MPSolverResultStatus2;
})(MPSolverResultStatus || {});
var DoubleParam = /* @__PURE__ */ ((DoubleParam2) => {
  DoubleParam2[DoubleParam2["RELATIVE_MIP_GAP"] = 0] = "RELATIVE_MIP_GAP";
  DoubleParam2[DoubleParam2["PRIMAL_TOLERANCE"] = 1] = "PRIMAL_TOLERANCE";
  DoubleParam2[DoubleParam2["DUAL_TOLERANCE"] = 2] = "DUAL_TOLERANCE";
  return DoubleParam2;
})(DoubleParam || {});
var IntegerParam = /* @__PURE__ */ ((IntegerParam2) => {
  IntegerParam2[IntegerParam2["PRESOLVE"] = 1e3] = "PRESOLVE";
  IntegerParam2[IntegerParam2["LP_ALGORITHM"] = 1001] = "LP_ALGORITHM";
  IntegerParam2[IntegerParam2["INCREMENTALITY"] = 1002] = "INCREMENTALITY";
  IntegerParam2[IntegerParam2["SCALING"] = 1003] = "SCALING";
  return IntegerParam2;
})(IntegerParam || {});
var PresolveValues = /* @__PURE__ */ ((PresolveValues2) => {
  PresolveValues2[PresolveValues2["PRESOLVE_OFF"] = 0] = "PRESOLVE_OFF";
  PresolveValues2[PresolveValues2["PRESOLVE_ON"] = 1] = "PRESOLVE_ON";
  return PresolveValues2;
})(PresolveValues || {});
var LpAlgorithmValues = /* @__PURE__ */ ((LpAlgorithmValues2) => {
  LpAlgorithmValues2[LpAlgorithmValues2["DUAL"] = 10] = "DUAL";
  LpAlgorithmValues2[LpAlgorithmValues2["PRIMAL"] = 11] = "PRIMAL";
  LpAlgorithmValues2[LpAlgorithmValues2["BARRIER"] = 12] = "BARRIER";
  return LpAlgorithmValues2;
})(LpAlgorithmValues || {});
var IncrementalityValues = /* @__PURE__ */ ((IncrementalityValues2) => {
  IncrementalityValues2[IncrementalityValues2["INCREMENTALITY_OFF"] = 0] = "INCREMENTALITY_OFF";
  IncrementalityValues2[IncrementalityValues2["INCREMENTALITY_ON"] = 1] = "INCREMENTALITY_ON";
  return IncrementalityValues2;
})(IncrementalityValues || {});
var ScalingValues = /* @__PURE__ */ ((ScalingValues2) => {
  ScalingValues2[ScalingValues2["SCALING_OFF"] = 0] = "SCALING_OFF";
  ScalingValues2[ScalingValues2["SCALING_ON"] = 1] = "SCALING_ON";
  return ScalingValues2;
})(ScalingValues || {});
var workerSupportedProblemTypes = /* @__PURE__ */ new Set([
...
var workerSolverTypeAliases = /* @__PURE__ */ new Map([
...
function workerDoubleDefault(param) {
  if (param === 0 /* RELATIVE_MIP_GAP */) return MPSolverParameters.kDefaultRelativeMipGap;
  if (param === 1 /* PRIMAL_TOLERANCE */) return MPSolverParameters.kDefaultPrimalTolerance;
  if (param === 2 /* DUAL_TOLERANCE */) return MPSolverParameters.kDefaultDualTolerance;
  return 0;
}
function workerIntegerDefault(param) {
  if (param === 1e3 /* PRESOLVE */) return MPSolverParameters.kDefaultPresolve;
  if (param === 1002 /* INCREMENTALITY */) return MPSolverParameters.kDefaultIncrementality;
  if (param === 1001 /* LP_ALGORITHM */) return 10 /* DUAL */;
  if (param === 1003 /* SCALING */) return 1 /* SCALING_ON */;
  return 0;
}
function workerStatusToResultStatus(status) {
  ...
  if (status === "MPSOLVER_OPTIMAL") return 0 /* OPTIMAL */;
  if (status === "MPSOLVER_FEASIBLE") return 1 /* FEASIBLE */;
  if (status === "MPSOLVER_INFEASIBLE") return 2 /* INFEASIBLE */;
  if (status === "MPSOLVER_UNBOUNDED") return 3 /* UNBOUNDED */;
  if (status === "MPSOLVER_ABNORMAL") return 4 /* ABNORMAL */;
  if (status === "MPSOLVER_MODEL_INVALID" || status === "MPSOLVER_MODEL_INVALID_SOLUTION_HINT" || status === "MPSOLVER_MODEL_INVALID_SOLVER_PARAMETERS") {
    return 5 /* MODEL_INVALID */;
  }
  return 6 /* NOT_SOLVED */;
}
...
function workerBasisStatusForBounds(value, lb, ub) {
  ...
  if (Number.isFinite(lb) && Number.isFinite(ub) && Math.abs(lb - ub) <= tolerance) {
    return 3 /* FIXED_VALUE */;
  }
  if (Number.isFinite(lb) && Math.abs(value - lb) <= tolerance) return 1 /* AT_LOWER_BOUND */;
  if (Number.isFinite(ub) && Math.abs(value - ub) <= tolerance) return 2 /* AT_UPPER_BOUND */;
  return 4 /* BASIC */;
}
...
function workerModelRequest(state, options = {}) {
  ...
  const timeLimitSeconds = options.timeLimitSeconds ?? (state.timeLimitMs > 0 ? state.timeLimitMs / 1e3 : void 0);
  if (timeLimitSeconds !== void 0) request.solverTimeLimitSeconds = timeLimitSeconds;
...
function applyWorkerSolutionResponse(state, response) {
  ...
  state.objective.bestBound = workerProblemIsMip(state.problemType) && typeof response.bestObjectiveBound === "number" ? response.bestObjectiveBound : state.objective.value;
  const solveInfo = response.solveInfo;
  if (typeof solveInfo?.solveWallTimeSeconds === "number") {
    state.wallTimeMs = Math.round(solveInfo.solveWallTimeSeconds * 1e3);
  }
...
function resetWorkerSolution(state) {
  for (const variable of state.variables) {
    ...
    variable.basisStatus = 0 /* FREE */;
  }
  for (const constraint of state.constraints) {
    constraint.dualValue = 0;
    constraint.basisStatus = 0 /* FREE */;
  }
...
var NativeMPSolverParametersBackend = class {
...
var BridgeMPSolverParametersBackend = class {
  doubleParams = /* @__PURE__ */ new Map();
  integerParams = /* @__PURE__ */ new Map();
  nativeHandle() {
...
var NativeMPSolverBackend = class _NativeMPSolverBackend {
  constructor(module, exports, nameOrHandle, problemType) {
    ...
    if (typeof nameOrHandle === "number") {
      ...
      this.handle = withCString(this.module, nameOrHandle, (namePtr) => {
        return this.exports.solverCreate(namePtr, problemType);
      });
    }
    if (this.handle === 0) {
  ...
  static create(name, problemType) {
    return new _NativeMPSolverBackend(getMpSolverModule(), getMpSolverExports(), name, problemType);
  }
  static createSolver(solverId) {
    ...
    return handle === 0 ? null : new _NativeMPSolverBackend(module, exports, handle);
  }
  name() {
  ...
  addConstraint(lb, ub, name) {
    ...
    const handle = withCString(this.module, name, (namePtr) => {
      return hasBounds ? this.exports.solverRowConstraint(this.handle, lb, ub, namePtr) : this.exports.solverUnboundedRowConstraint(this.handle, namePtr);
    });
...
var BridgeMPSolverBackend = class {
  state;
...
var MPSolverParameters = class {
  static RELATIVE_MIP_GAP = 0 /* RELATIVE_MIP_GAP */;
  static PRIMAL_TOLERANCE = 1 /* PRIMAL_TOLERANCE */;
  static DUAL_TOLERANCE = 2 /* DUAL_TOLERANCE */;
  static PRESOLVE = 1e3 /* PRESOLVE */;
  static LP_ALGORITHM = 1001 /* LP_ALGORITHM */;
  static INCREMENTALITY = 1002 /* INCREMENTALITY */;
  static SCALING = 1003 /* SCALING */;
  static PRESOLVE_OFF = 0 /* PRESOLVE_OFF */;
  static PRESOLVE_ON = 1 /* PRESOLVE_ON */;
  static DUAL = 10 /* DUAL */;
  static PRIMAL = 11 /* PRIMAL */;
  static BARRIER = 12 /* BARRIER */;
  static INCREMENTALITY_OFF = 0 /* INCREMENTALITY_OFF */;
  static INCREMENTALITY_ON = 1 /* INCREMENTALITY_ON */;
  static SCALING_OFF = 0 /* SCALING_OFF */;
  static SCALING_ON = 1 /* SCALING_ON */;
  static kDefaultRelativeMipGap = 1e-4;
  static kDefaultPrimalTolerance = 1e-7;
  static kDefaultDualTolerance = 1e-7;
  static kDefaultPresolve = 1 /* PRESOLVE_ON */;
  static kDefaultIncrementality = 1 /* INCREMENTALITY_ON */;
  backend;
  constructor() {
...
var MPSolver = class _MPSolver {
  static CLP_LINEAR_PROGRAMMING = 0 /* CLP_LINEAR_PROGRAMMING */;
  static GLPK_LINEAR_PROGRAMMING = 1 /* GLPK_LINEAR_PROGRAMMING */;
  static GLOP_LINEAR_PROGRAMMING = 2 /* GLOP_LINEAR_PROGRAMMING */;
  static PDLP_LINEAR_PROGRAMMING = 8 /* PDLP_LINEAR_PROGRAMMING */;
  static HIGHS_LINEAR_PROGRAMMING = 15 /* HIGHS_LINEAR_PROGRAMMING */;
  static SCIP_MIXED_INTEGER_PROGRAMMING = 3 /* SCIP_MIXED_INTEGER_PROGRAMMING */;
  static GLPK_MIXED_INTEGER_PROGRAMMING = 4 /* GLPK_MIXED_INTEGER_PROGRAMMING */;
  static CBC_MIXED_INTEGER_PROGRAMMING = 5 /* CBC_MIXED_INTEGER_PROGRAMMING */;
  static HIGHS_MIXED_INTEGER_PROGRAMMING = 16 /* HIGHS_MIXED_INTEGER_PROGRAMMING */;
  static GUROBI_LINEAR_PROGRAMMING = 6 /* GUROBI_LINEAR_PROGRAMMING */;
  static GUROBI_MIXED_INTEGER_PROGRAMMING = 7 /* GUROBI_MIXED_INTEGER_PROGRAMMING */;
  static CPLEX_LINEAR_PROGRAMMING = 10 /* CPLEX_LINEAR_PROGRAMMING */;
  static CPLEX_MIXED_INTEGER_PROGRAMMING = 11 /* CPLEX_MIXED_INTEGER_PROGRAMMING */;
  static XPRESS_LINEAR_PROGRAMMING = 101 /* XPRESS_LINEAR_PROGRAMMING */;
  static XPRESS_MIXED_INTEGER_PROGRAMMING = 102 /* XPRESS_MIXED_INTEGER_PROGRAMMING */;
  static COPT_LINEAR_PROGRAMMING = 103 /* COPT_LINEAR_PROGRAMMING */;
  static COPT_MIXED_INTEGER_PROGRAMMING = 104 /* COPT_MIXED_INTEGER_PROGRAMMING */;
  static BOP_INTEGER_PROGRAMMING = 12 /* BOP_INTEGER_PROGRAMMING */;
  static SAT_INTEGER_PROGRAMMING = 14 /* SAT_INTEGER_PROGRAMMING */;
  static KNAPSACK_MIXED_INTEGER_PROGRAMMING = 13 /* KNAPSACK_MIXED_INTEGER_PROGRAMMING */;
  static OPTIMAL = 0 /* OPTIMAL */;
  static FEASIBLE = 1 /* FEASIBLE */;
  static INFEASIBLE = 2 /* INFEASIBLE */;
  static UNBOUNDED = 3 /* UNBOUNDED */;
  static ABNORMAL = 4 /* ABNORMAL */;
  static MODEL_INVALID = 5 /* MODEL_INVALID */;
  static NOT_SOLVED = 6 /* NOT_SOLVED */;
  static FREE = 0 /* FREE */;
  static AT_LOWER_BOUND = 1 /* AT_LOWER_BOUND */;
  static AT_UPPER_BOUND = 2 /* AT_UPPER_BOUND */;
  static FIXED_VALUE = 3 /* FIXED_VALUE */;
  static BASIC = 4 /* BASIC */;
  ready = Promise.resolve();
  backend;
  objective;
  constructor(nameOrModule, problemTypeOrExports, maybeHandle) {
    if (typeof nameOrModule === "string") {
      this.backend = shouldUseMPSolverBridge() ? new BridgeMPSolverBackend(nameOrModule, problemTypeOrExports) : NativeMPSolverBackend.create(nameOrModule, problemTypeOrExports);
    } else {
      this.backend = new NativeMPSolverBackend(nameOrModule, problemTypeOrExports, maybeHandle ?? 0);
    }
  ...
  static ParseAndCheckSupportForProblemType(solverId) {
    ...
    return _MPSolver.SupportsProblemType(problemType) ? problemType : null;
  }
  ...
  async SolveWithProto(options = {}) {
    ...
    const result = await _MPSolver.solveModelRequest(requestBytes, options);
    let loaded = false;
