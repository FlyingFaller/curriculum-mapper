...
var protobufRootPromise = null;
var cpModelTypePromise = null;
var cpSolverResponseTypePromise = null;
var satParametersTypePromise = null;
...
function normalizeSatParameters(params) {
  ...
  if (normalizedParams.numWorkers !== void 0) {
...
async function solveRawDirect(modelBytes, paramsBytes = null, callbacks, solverType) {
  ...
  const useCallbackEnvelope = flags !== 0 && solverType !== void 0;
  try {
...
async function solve(modelBytes, params = null, callbacks) {
  ...
  const solverType = callbacks && callbackFlags(callbacks) ? await resolveCpSolverResponseType() : void 0;
  const started = typeof performance !== "undefined" ? performance.now() : Date.now();
  const bytes = await solveRaw(modelBytes, paramsBytes, callbacks, solverType);
  const elapsedSeconds = ((typeof performance !== "undefined" ? performance.now() : Date.now()) - started) / 1e3;
  let response = null;
  if (bytes.length > 0) {
...
var CpModel = class _CpModel {
  model;
  boolVariableIndexes = /* @__PURE__ */ new Set();
  constantIndexes = /* @__PURE__ */ new Map();
  intVariables = /* @__PURE__ */ new Map();
  trueConstant = null;
  falseConstant = null;
  constructor(model) {
