export declare class GlopParameters {
    readonly options: GlopParametersOptions;
    constructor(options?: GlopParametersOptions);
    toProtoBytes(): Uint8Array;
}

export declare type GlopParametersOptions = {
    useScaling?: boolean;
    use_scaling?: boolean;
...
export declare class GlpkParameters {
...
export declare enum GScipMetaParamValue {
...
export declare class GScipParameters {
    readonly options: GScipParametersOptions;
    constructor(options?: GScipParametersOptions);
    toProtoBytes(): Uint8Array;
}

export declare type GScipParametersOptions = {
...
declare type IndicatorConstraintData = {
    id: number;
...
export declare class MathOpt {
    static readonly SolverType: typeof MathOptSolverType;
    static readonly LPAlgorithm: typeof MathOptLPAlgorithm;
    static readonly Emphasis: typeof MathOptEmphasis;
    static readonly GScipEmphasis: typeof GScipEmphasis;
    static readonly GScipMetaParamValue: typeof GScipMetaParamValue;
    static readonly GScipParameters: typeof GScipParameters;
    static readonly GlopParameters: typeof GlopParameters;
    static readonly PdlpParameters: typeof PdlpParameters;
    static readonly PdlpOptimalityNorm: typeof PdlpOptimalityNorm;
    static readonly PdlpSchedulerType: typeof PdlpSchedulerType;
    static readonly PdlpRestartStrategy: typeof PdlpRestartStrategy;
    static readonly PdlpLinesearchRule: typeof PdlpLinesearchRule;
    static readonly GlpkParameters: typeof GlpkParameters;
    static readonly SolveInterrupter: typeof MathOptSolveInterrupter;
    static readonly SolveParameters: typeof MathOptSolveParameters;
    static readonly ModelSolveParameters: typeof MathOptModelSolveParameters;
    static readonly SparseVectorFilter: typeof MathOptSparseVectorFilter;
    static readonly SolutionHint: typeof MathOptSolutionHint;
    static readonly IncrementalSolver: typeof MathOptIncrementalSolver;
    static readonly LinearExpression: typeof MathOptLinearExpression;
    static readonly QuadraticExpression: typeof MathOptQuadraticExpression;
    static readonly QuadraticTermKey: typeof MathOptQuadraticTermKey;
    static readonly VarEqVar: typeof MathOptVarEqVar;
    static readonly BoundedExpression: typeof MathOptBoundedExpression;
    static readonly LowerBoundedExpression: typeof MathOptLowerBoundedExpression;
    static readonly UpperBoundedExpression: typeof MathOptUpperBoundedExpression;
    static setWorkerBridgeEnabled(enabled: boolean): void;
    static isWorkerBridgeEnabled(): boolean;
    static Model(name?: string): MathOptModel;
    static solve(model: MathOptModel, options?: MathOptSolveOptions): Promise<MathOptSolveResult>;
    static encodeSolveRequest(model: MathOptModel, options?: MathOptSolveOptions): Uint8Array;
    static linearTerm(variable: MathOptVariable, coefficient?: number): MathOptLinearTerm;
    static quadraticTerm(firstVariable: MathOptVariable, secondVariable: MathOptVariable, coefficient?: number): MathOptQuadraticTerm;
    static linearExpression(terms?: Iterable<MathOptLinearTerm>, offset?: number): MathOptLinearExpression;
    static quadraticExpression(linearTerms?: Iterable<MathOptLinearTerm>, quadraticTerms?: Iterable<MathOptQuadraticTerm>, offset?: number): MathOptQuadraticExpression;
    ...
    static multiplyLinearExpressions(lhs: MathOptLinearExpressionInput, rhs: MathOptLinearExpressionInput): MathOptQuadraticExpression;
    static evaluateExpression(expression: MathOptQuadraticExpressionInput, variableValues: ReadonlyMap<unknown, number> | Record<number | string, number>): number;
    static boundedExpression<TExpression>(lowerBound: number, expression: TExpression, upperBound: number): MathOptBoundedExpression<TExpression>;
    static lowerBoundedExpression<TExpression>(lowerBound: number, expression: TExpression): MathOptLowerBoundedExpression<TExpression>;
    static upperBoundedExpression<TExpression>(expression: TExpression, upperBound: number): MathOptUpperBoundedExpression<TExpression>;
    static eq(lhs: MathOptQuadraticExpressionInput, rhs: MathOptQuadraticExpressionInput): MathOptBoundedExpression<MathOptLinearExpression | MathOptQuadraticExpression>;
    ...
    static le(lhs: MathOptQuadraticExpressionInput, rhs: MathOptQuadraticExpressionInput): MathOptUpperBoundedExpression<MathOptLinearExpression | MathOptQuadraticExpression> | MathOptLowerBoundedExpression<MathOptQuadraticExpression> | MathOptBoundedExpression<MathOptLinearExpression | MathOptQuadraticExpression>;
    static ge(lhs: MathOptQuadraticExpressionInput, rhs: MathOptQuadraticExpressionInput): MathOptLowerBoundedExpression<MathOptLinearExpression | MathOptQuadraticExpression> | MathOptUpperBoundedExpression<MathOptQuadraticExpression> | MathOptBoundedExpression<MathOptLinearExpression | MathOptQuadraticExpression>;
    static completeUpperBound<TExpression>(lowerBounded: MathOptLowerBoundedExpression<TExpression>, upperBound: number): MathOptBoundedExpression<TExpression>;
    static completeLowerBound<TExpression>(lowerBound: number, upperBounded: MathOptUpperBoundedExpression<TExpression>): MathOptBoundedExpression<TExpression>;
}

export declare type MathOptBasisResult = {
...
declare class MathOptBoundedExpression<TExpression = unknown> {
    readonly lowerBound: number;
    readonly expression: TExpression;
    readonly upperBound: number;
    constructor(lowerBound: number, expression: TExpression, upperBound: number);
...
export declare type MathOptDualRayResult = {
...
export declare type MathOptDualSolutionResult = {
...
export declare enum MathOptEmphasis {
    UNSPECIFIED = 0,
    OFF = 1,
    LOW = 2,
    MEDIUM = 3,
...
export declare class MathOptIncrementalSolver {
    readonly model: MathOptModel;
    readonly solverType: MathOptSolverType | keyof typeof MathOptSolverType;
    readonly options: Omit<MathOptSolveOptions, 'solverType'>;
    private readonly initPromise;
    private checkpoint;
    private handle;
    private closed;
    private readonly useWorkerBridge;
    constructor(model: MathOptModel, solverType?: MathOptSolverType | keyof typeof MathOptSolverType, options?: Omit<MathOptSolveOptions, 'solverType'>);
    private create;
...
export declare class MathOptIndicatorConstraint {
    readonly model: MathOptModel;
    readonly data: IndicatorConstraintData;
    constructor(model: MathOptModel, data: IndicatorConstraintData);
    get id(): number;
    get name(): string;
...
export declare type MathOptIndicatorConstraintOptions = {
    indicator?: MathOptVariable;
    activateOnZero?: boolean;
    activate_on_zero?: boolean;
    impliedConstraint?: MathOptBoundedExpression<MathOptLinearExpression> | MathOptLowerBoundedExpression<MathOptLinearExpression> | MathOptUpperBoundedExpression<MathOptLinearExpression>;
...
declare type MathOptIndicatorConstraintSnapshot = {
    id: number;
    indicatorId?: number;
    activateOnZero: boolean;
    lowerBound: number;
...
export declare class MathOptLinearConstraint {
    readonly model: MathOptModel;
    readonly data: LinearConstraintData;
    constructor(model: MathOptModel, data: LinearConstraintData);
    get id(): number;
    get name(): string;
    get lowerBound(): number;
...
export declare type MathOptLinearConstraintMatrixEntry = {
...
declare type MathOptLinearConstraintOptions = {
    lb?: number;
    ub?: number;
    expr?: MathOptLinearExpressionInput;
    lowerBound?: number;
...
declare type MathOptLinearConstraintSnapshot = {
    id: number;
    lowerBound: number;
    upperBound: number;
    terms: Array<{
...
declare class MathOptLinearExpression {
    readonly offset: number;
    readonly terms: ReadonlyMap<MathOptVariable, number>;
    constructor(terms?: Iterable<MathOptLinearTerm> | MathOptLinearExpressionInput, offset?: number);
...
declare type MathOptLinearExpressionInput = number | MathOptVariable | MathOptLinearTerm | MathOptLinearExpression;

export declare type MathOptLinearTerm = {
    variable: MathOptVariable;
    coefficient: number;
};

declare class MathOptLowerBoundedExpression<TExpression = unknown> {
    readonly lowerBound: number;
    readonly expression: TExpression;
    readonly upperBound: number;
    constructor(lowerBound: number, expression: TExpression);
    get lower_bound(): number;
    get upper_bound(): number;
...
export declare enum MathOptLPAlgorithm {
    UNSPECIFIED = 0,
    PRIMAL_SIMPLEX = 1,
    DUAL_SIMPLEX = 2,
    BARRIER = 3,
...
export declare class MathOptModel {
    readonly name: string;
    private readonly variableData;
    private readonly constraints;
    private readonly indicatorConstraints;
    private objectiveDataValue;
    ...
    addLinearConstraint(options?: Partial<MathOptLinearConstraintOptions> | MathOptBoundedExpression<MathOptLinearExpression> | MathOptLowerBoundedExpression<MathOptLinearExpression> | MathOptUpperBoundedExpression<MathOptLinearExpression>): MathOptLinearConstraint;
    ...
    private normalizeIndicatorConstraintOptions;
    ...
    getVariable(id: number, validate?: boolean): MathOptVariable | undefined;
    get_variable(id: number, options?: {
        validate?: boolean;
    }): MathOptVariable;
    ...
    getLinearConstraint(id: number, validate?: boolean): MathOptLinearConstraint | undefined;
    get_linear_constraint(id: number, options?: {
        validate?: boolean;
    }): MathOptLinearConstraint;
    maximize(terms: MathOptQuadraticExpressionInput | MathOptLinearTerm[], offset?: number): void;
    minimize(terms: MathOptQuadraticExpressionInput | MathOptLinearTerm[], offset?: number): void;
    maximizeLinearObjective(terms: MathOptLinearExpressionInput | MathOptLinearTerm[], offset?: number): void;
    maximize_linear_objective(terms: MathOptLinearExpressionInput | MathOptLinearTerm[], offset?: number): void;
    minimizeLinearObjective(terms: MathOptLinearExpressionInput | MathOptLinearTerm[], offset?: number): void;
    minimize_linear_objective(terms: MathOptLinearExpressionInput | MathOptLinearTerm[], offset?: number): void;
    setObjective(terms: MathOptQuadraticExpressionInput | MathOptLinearTerm[], isMaximize: boolean, offset?: number): void;
    set_objective(terms: MathOptQuadraticExpressionInput | MathOptLinearTerm[], is_maximize: boolean, offset?: number): void;
    setLinearObjective(terms: MathOptLinearExpressionInput | MathOptLinearTerm[], isMaximize: boolean, offset?: number): void;
    set_linear_objective(terms: MathOptLinearExpressionInput | MathOptLinearTerm[], is_maximize: boolean, offset?: number): void;
    setQuadraticObjective(terms: MathOptQuadraticExpressionInput | MathOptLinearTerm[], isMaximize: boolean, offset?: number): void;
    set_quadratic_objective(terms: MathOptQuadraticExpressionInput | MathOptLinearTerm[], is_maximize: boolean, offset?: number): void;
    ...
    encodeModelUpdateSince(snapshot: MathOptModelSnapshot, options?: {
        removeNames?: boolean;
    }): Uint8Array | null;
    ...
    private encodeVariables;
    private encodeObjective;
    private encodeLinearConstraints;
    private encodeLinearConstraintMatrix;
    private encodeIndicatorConstraints;
}

declare type MathOptModelSnapshot = {
...
export declare class MathOptModelSolveParameters {
    readonly options: MathOptModelSolveParametersOptions;
    constructor(options?: MathOptModelSolveParametersOptions);
    toProtoBytes(): Uint8Array;
...
export declare type MathOptModelSolveParametersOptions = {
    ...
    branchingPriorities?: Array<{
        variable: MathOptVariable;
        priority: number;
    }>;
    branching_priorities?: Array<{
        variable: MathOptVariable;
        priority: number;
    }>;
...
export declare class MathOptObjective {
    private readonly model;
    constructor(model: MathOptModel);
...
declare type MathOptObjectiveData = {
    maximize: boolean;
    linearTerms: MathOptLinearTerm[];
    quadraticTerms: MathOptQuadraticTerm[];
    offset: number;
...
declare type MathOptObjectiveSnapshot = {
    maximize: boolean;
    offset: number;
    linearTerms: Array<{
        variableId: number;
    ...
    quadraticTerms: Array<{
        firstVariableId: number;
        secondVariableId: number;
        coefficient: number;
    }>;
};

export declare type MathOptPrimalRayResult = {
    variableValues: Record<string, number>;
    variableValuesById: Record<number, number>;
};

export declare type MathOptPrimalSolutionResult = {
    objectiveValue: number | null;
    variableValues: Record<string, number>;
    variableValuesById: Record<number, number>;
    feasibilityStatus: string;
...
declare class MathOptQuadraticExpression {
    readonly offset: number;
    ...
    constructor(linearTerms?: Iterable<MathOptLinearTerm> | MathOptQuadraticExpressionInput, quadraticTerms?: Iterable<MathOptQuadraticTerm>, offset?: number);
...
declare type MathOptQuadraticExpressionInput = MathOptLinearExpressionInput | MathOptQuadraticTerm | MathOptQuadraticExpression;

declare type MathOptQuadraticTerm = {
    firstVariable: MathOptVariable;
    secondVariable: MathOptVariable;
    coefficient: number;
};

declare class MathOptQuadraticTermKey {
...
export declare class MathOptSolutionHint {
    readonly options: MathOptSolutionHintOptions;
    constructor(options?: MathOptSolutionHintOptions);
    toProtoBytes(): Uint8Array;
}

export declare type MathOptSolutionHintOptions = {
...
export declare type MathOptSolveInterrupterLike = {
    readonly interrupted?: boolean;
    isInterrupted?(): boolean;
    is_interrupted?(): boolean;
};

export declare type MathOptSolveOptions = {
...
export declare class MathOptSolveParameters {
    readonly options: MathOptSolveParametersOptions;
    constructor(options?: MathOptSolveParametersOptions);
    toProtoBytes(): Uint8Array;
}

export declare type MathOptSolveParametersOptions = Omit<MathOptSolveOptions, 'solverType' | 'removeNames' | 'remove_names' | 'interrupter' | 'solveInterrupter' | 'solve_interrupter' | 'messageCallback' | 'message_callback' | 'msgCb' | 'msg_cb' | 'parameters' | 'solveParameters' | 'solve_parameters' | 'modelParameters' | 'model_parameters'>;

export declare type MathOptSolveResult = {
...
export declare enum MathOptSolverType {
    GSCIP = 1,
    GUROBI = 2,
    GLOP = 3,
    CP_SAT = 4,
...
export declare class MathOptSparseVectorFilter<TElement = unknown> {
    readonly options: MathOptSparseVectorFilterOptions<TElement>;
    constructor(options?: MathOptSparseVectorFilterOptions<TElement>);
    toProtoBytes(): Uint8Array;
}

export declare type MathOptSparseVectorFilterInput<TElement = unknown> = MathOptSparseVectorFilter<TElement> | MathOptSparseVectorFilterOptions<TElement> | TElement[] | Array<number | bigint>;

export declare type MathOptSparseVectorFilterOptions<TElement = unknown> = {
...
declare class MathOptUpperBoundedExpression<TExpression = unknown> {
    readonly expression: TExpression;
    readonly upperBound: number;
    readonly lowerBound: number;
    constructor(expression: TExpression, upperBound: number);
    get lower_bound(): number;
    get upper_bound(): number;
...
export declare class MathOptVariable {
    readonly model: MathOptModel;
    readonly data: VariableData;
    constructor(model: MathOptModel, data: VariableData);
    get id(): number;
    get name(): string;
    get lowerBound(): number;
    set lowerBound(value: number);
...
export declare type MathOptVariableOptions = {
    lb?: number;
    ub?: number;
    isInteger?: boolean;
    is_integer?: boolean;
...
declare type MathOptVariableSnapshot = {
    id: number;
    lowerBound: number;
    upperBound: number;
    integer: boolean;
...
export declare enum PdlpLinesearchRule {
    UNSPECIFIED = 0,
...
export declare enum PdlpOptimalityNorm {
    UNSPECIFIED = 0,
    L_INF = 1,
    L2 = 2,
...
export declare class PdlpParameters {
    readonly options: PdlpParametersOptions;
    constructor(options?: PdlpParametersOptions);
    toProtoBytes(): Uint8Array;
}

export declare type PdlpParametersOptions = {
    terminationCriteria?: {
...
export declare enum PdlpRestartStrategy {
    UNSPECIFIED = 0,
    NO_RESTARTS = 1,
...
export declare enum PdlpSchedulerType {
    UNSPECIFIED = 0,
    GOOGLE_THREADPOOL = 1,
    EIGEN_THREADPOOL = 3
}
