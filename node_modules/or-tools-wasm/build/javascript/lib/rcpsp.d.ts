 ...
 */
declare type AllDifferentConstraintProto = {
 ...
 * automaton.
 */
declare type AutomatonConstraintProto = {
    /**
 ...
 */
declare type BoolArgumentProto = {
    literals?: Array<number>;
};

declare class BoolVar extends IntVar {
    get literalIndex(): number;
    not(): NotBoolVar;
}

declare class BoundedLinearExpr {
    readonly expression: LinearExpr;
    readonly lowerBound: ProtoInt64;
    readonly upperBound: ProtoInt64;
    readonly domain?: ProtoInt64[] | undefined;
    constructor(expression: LinearExpr, lowerBound: ProtoInt64, upperBound: ProtoInt64, domain?: ProtoInt64[] | undefined);
    toString(): string;
 ...
 */
declare type CircuitConstraintProto = {
    tails?: Array<number>;
    heads?: Array<number>;
    literals?: Array<number>;
};
...
declare class Constraint {
    ...
    constructor(model: CpModel, index: number);
    get name(): string;
    withName(name: string): this;
    with_name(name: string): this;
    onlyEnforceIf(literals: LiteralLike | Iterable<LiteralLike>, ...rest: LiteralLike[]): this;
}

/**
 * Next id: 31
 */
declare type ConstraintProto = {
    /**
...
declare class CpModel {
    private readonly model;
    private readonly boolVariableIndexes;
    private readonly constantIndexes;
    private readonly intVariables;
    private trueConstant;
    private falseConstant;
    ...
    newIntVar(lb: ProtoInt64, ub: ProtoInt64, name?: string): IntVar;
    new_int_var(lb: ProtoInt64, ub: ProtoInt64, name?: string): IntVar;
    NewIntVar(lb: ProtoInt64, ub: ProtoInt64, name?: string): IntVar;
    newIntVarFromDomain(domain: Domain, name?: string): IntVar;
    new_int_var_from_domain(domain: Domain, name?: string): IntVar;
    NewIntVarFromDomain(domain: Domain, name?: string): IntVar;
    newBoolVar(name?: string): BoolVar;
    new_bool_var(name?: string): BoolVar;
    NewBoolVar(name?: string): BoolVar;
    newConstant(value: number, name?: string): IntVar;
    new_constant(value: number, name?: string): IntVar;
    NewConstant(value: number, name?: string): IntVar;
    getIntVarFromProtoIndex(index: number): IntVar;
    get_int_var_from_proto_index(index: number): IntVar;
    getBoolVarFromProtoIndex(index: number): BoolVar;
    get_bool_var_from_proto_index(index: number): BoolVar;
    getIntervalVarFromProtoIndex(index: number): IntervalVar;
    get_interval_var_from_proto_index(index: number): IntervalVar;
    getOrMakeIndexFromConstant(value: number): number;
    ...
    is_boolean_value(value: unknown): value is boolean;
    isBooleanIndex(index: number): boolean;
    get_or_make_variable_index(variable: unknown): number;
    add(bound: BoundedLinearExpr | boolean): Constraint;
    Add(bound: BoundedLinearExpr | boolean): Constraint;
    addLinearConstraint(expression: LinearExprLike, lb: ProtoInt64, ub: ProtoInt64, domain?: ProtoInt64[]): Constraint;
    add_linear_constraint(expression: LinearExprLike, lb: number, ub: number): Constraint;
    AddLinearConstraint(expression: LinearExprLike, lb: ProtoInt64, ub: ProtoInt64): Constraint;
    addEquality(left: LinearExprLike, right: LinearExprLike): Constraint;
    addAllDifferent(expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    AddAllDifferent(expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    addElement(index: LinearExprLike, expressions: Iterable<LinearExprLike | number>, target: LinearExprLike): Constraint;
    addAllowedAssignments(expressions: Iterable<LinearExprLike>, tuples: Iterable<Iterable<number>>): Constraint;
    addForbiddenAssignments(expressions: Iterable<LinearExprLike>, tuples: Iterable<Iterable<number>>): Constraint;
    addAutomaton(expressions: Iterable<LinearExprLike>, startingState: number, finalStates: Iterable<number>, transitions: Iterable<[number, number, number]>): Constraint;
    addCircuit(arcs: Iterable<[number, number, LiteralLike]>): Constraint;
    addMultipleCircuit(arcs: Iterable<[number, number, LiteralLike]>): Constraint;
    addInverse(direct: Iterable<IntVar>, inverse: Iterable<IntVar>): Constraint;
    addMaxEquality(target: LinearExprLike, expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    add_max_equality(target: LinearExprLike, expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    addMinEquality(target: LinearExprLike, expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    add_min_equality(target: LinearExprLike, expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    addAbsEquality(target: LinearExprLike, expression: LinearExprLike): Constraint;
    add_abs_equality(target: LinearExprLike, expression: LinearExprLike): Constraint;
    addDivisionEquality(target: LinearExprLike, numerator: LinearExprLike, denominator: LinearExprLike): Constraint;
    add_division_equality(target: LinearExprLike, numerator: LinearExprLike, denominator: LinearExprLike): Constraint;
    addModuloEquality(target: LinearExprLike, expression: LinearExprLike, modulo: LinearExprLike): Constraint;
    add_modulo_equality(target: LinearExprLike, expression: LinearExprLike, modulo: LinearExprLike): Constraint;
    addMultiplicationEquality(target: LinearExprLike, expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    add_multiplication_equality(target: LinearExprLike, expressions: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): Constraint;
    addImplication(left: LiteralLike, right: LiteralLike): Constraint;
    add_implication(left: LiteralLike, right: LiteralLike): Constraint;
    addBoolOr(literals: Iterable<LiteralLike> | LiteralLike, ...rest: LiteralLike[]): Constraint;
    add_bool_or(literals: Iterable<LiteralLike> | LiteralLike, ...rest: LiteralLike[]): Constraint;
    AddBoolOr(literals: Iterable<LiteralLike> | LiteralLike, ...rest: LiteralLike[]): Constraint;
    addAtLeastOne(literals: Iterable<LiteralLike> | LiteralLike, ...rest: LiteralLike[]): Constraint;
    add_at_least_one(literals: Iterable<LiteralLike> | LiteralLike, ...rest: LiteralLike[]): Constraint;
    addBoolAnd(literals: Iterable<LiteralLike>): Constraint;
    add_bool_and(literals: Iterable<LiteralLike>): Constraint;
    AddBoolAnd(literals: Iterable<LiteralLike>): Constraint;
    addBoolXor(literals: Iterable<LiteralLike>): Constraint;
    add_bool_xor(literals: Iterable<LiteralLike>): Constraint;
    AddBoolXOr(literals: Iterable<LiteralLike>): Constraint;
    addAtMostOne(literals: Iterable<LiteralLike>): Constraint;
    add_at_most_one(literals: Iterable<LiteralLike>): Constraint;
    addExactlyOne(literals: Iterable<LiteralLike>): Constraint;
    add_exactly_one(literals: Iterable<LiteralLike>): Constraint;
    addMapDomain(variable: IntVar, booleanVariables: Iterable<BoolVar>, offset?: number): void;
    add_map_domain(variable: IntVar, booleanVariables: Iterable<BoolVar>, offset?: number): void;
    newIntervalVar(start: LinearExprLike, size: LinearExprLike, end: LinearExprLike, name?: string): IntervalVar;
    new_interval_var(start: LinearExprLike, size: LinearExprLike, end: LinearExprLike, name?: string): IntervalVar;
    newFixedSizeIntervalVar(start: LinearExprLike, size: number, name?: string): IntervalVar;
    new_fixed_size_interval_var(start: LinearExprLike, size: number, name?: string): IntervalVar;
    newOptionalFixedSizeIntervalVar(start: LinearExprLike, size: number, isPresent: LiteralLike, name?: string): IntervalVar;
    new_optional_fixed_size_interval_var(start: LinearExprLike, size: number, isPresent: LiteralLike, name?: string): IntervalVar;
    newOptionalIntervalVar(start: LinearExprLike, size: LinearExprLike, end: LinearExprLike, isPresent: LiteralLike, name?: string): IntervalVar;
    new_optional_interval_var(start: LinearExprLike, size: LinearExprLike, end: LinearExprLike, isPresent: LiteralLike, name?: string): IntervalVar;
    addNoOverlap(intervals: Iterable<IntervalVar>): Constraint;
    add_no_overlap(intervals: Iterable<IntervalVar>): Constraint;
    AddNoOverlap(intervals: Iterable<IntervalVar>): Constraint;
    addNoOverlap2D(xIntervals: Iterable<IntervalVar>, yIntervals: Iterable<IntervalVar>): Constraint;
    add_no_overlap_2d(xIntervals: Iterable<IntervalVar>, yIntervals: Iterable<IntervalVar>): Constraint;
    AddNoOverlap2D(xIntervals: Iterable<IntervalVar>, yIntervals: Iterable<IntervalVar>): Constraint;
    addCumulative(intervals: Iterable<IntervalVar>, demands: Iterable<LinearExprLike>, capacity: LinearExprLike): Constraint;
    add_cumulative(intervals: Iterable<IntervalVar>, demands: Iterable<LinearExprLike>, capacity: LinearExprLike): Constraint;
    addReservoirConstraint(times: Iterable<LinearExprLike>, levelChanges: Iterable<LinearExprLike>, minLevel: number, maxLevel: number, activeLiterals?: Iterable<LiteralLike>): Constraint;
    addDecisionStrategy(expressions: Iterable<LinearExprLike>, variableSelectionStrategy: DecisionStrategyProto_VariableSelectionStrategy, domainReductionStrategy: DecisionStrategyProto_DomainReductionStrategy): void;
    addHint(variable: IntVar | NotBoolVar, value: number | boolean): void;
    addAssumption(literal: LiteralLike): void;
    addAssumptions(literals: Iterable<LiteralLike>): void;
    clearAssumptions(): void;
    minimize(expression: LinearExprLike): void;
    Minimize(expression: LinearExprLike): void;
    maximize(expression: LinearExprLike): void;
    Maximize(expression: LinearExprLike): void;
    ...
    private checkExpressionModel;
    private expressionProto;
    private expressionFromProto;
    private literalFromProtoIndex;
    private expressionProtos;
    private variableIndexes;
    private intervalIndexes;
    private hasBooleanExpressionTerm;
    literalReferences(literals: Iterable<LiteralLike>): number[];
    private constantBoolIndex;
}

/**
 * A constraint programming problem.
 */
declare type CpModelProto = {
    /**
     * For debug/logging only. Can be empty.
     */
    name?: string;
...
declare type CpSatSolveCallbacks = {
    onSolution?: (response: CpSolverResponse, bytes: Uint8Array) => void;
    onBestBound?: (bound: number) => void;
    onLog?: (message: string) => void;
};

declare class CpSolver {
    private lastResponse;
    readonly parameters: SatParameters;
    bestBoundCallback: ((bound: number) => void) | null;
    logCallback: ((message: string) => void) | null;
    solve(model: CpModel, params?: SatParameters | Uint8Array | CpSolverSolutionCallback | null, callbacks?: CpSatSolveCallbacks): Promise<CpSolverStatus_Name | CpSolverStatus | undefined>;
    response(): CpSolverResponse | null;
    responseStats(): string;
    get best_objective_bound(): number;
    get deterministic_time(): number;
    get num_binary_propagations(): number;
    get num_integer_propagations(): number;
    get user_time(): number;
    get response_proto(): CpSolverResponse;
    get solve_log(): string | undefined;
    get num_booleans(): number;
    get num_conflicts(): number;
    get num_branches(): number;
    get num_integers(): number;
    get wall_time(): number;
    get objective_value(): number;
    ...
    get wallTime(): number;
    value(expression: LinearExprLike): number;
    floatValue(expression: LinearExprLike): number;
    booleanValue(literal: LiteralLike): boolean;
    objectiveValue(): number;
    bestObjectiveBound(): number;
    statusName(status?: CpSolverStatus_Name | CpSolverStatus | undefined): string;
    private requireResponse;
    get best_bound_callback(): ((bound: number) => void) | null;
    get log_callback(): ((message: string) => void) | null;
}
 ...
 */
declare type CpSolverSolution = {
    values?: Array<ProtoInt64>;
};

declare class CpSolverSolutionCallback {
    ...
    get wallTime(): number;
    _run(response: CpSolverResponse): void;
...
declare type CpSolverStatus_Name = 'UNKNOWN' | 'MODEL_INVALID' | 'FEASIBLE' | 'INFEASIBLE' | 'OPTIMAL';
 ...
 */
declare type CumulativeConstraintProto = {
 ...
 */
declare type DecisionStrategyProto = {
    /**
 ...
 */
declare enum DecisionStrategyProto_DomainReductionStrategy {
    SELECT_MIN_VALUE = 0,
    SELECT_MAX_VALUE = 1,
    SELECT_LOWER_HALF = 2,
    SELECT_UPPER_HALF = 3,
...
declare type DecisionStrategyProto_DomainReductionStrategy_Name = 'SELECT_MIN_VALUE' | 'SELECT_MAX_VALUE' | 'SELECT_LOWER_HALF' | 'SELECT_UPPER_HALF' | 'SELECT_MEDIAN_VALUE' | 'SELECT_RANDOM_HALF';
 ...
 * TODO(user): extend as needed.
 */
declare enum DecisionStrategyProto_VariableSelectionStrategy {
    CHOOSE_FIRST = 0,
    CHOOSE_LOWEST_MIN = 1,
...
declare type DecisionStrategyProto_VariableSelectionStrategy_Name = 'CHOOSE_FIRST' | 'CHOOSE_LOWEST_MIN' | 'CHOOSE_HIGHEST_MAX' | 'CHOOSE_MIN_DOMAIN_SIZE' | 'CHOOSE_MAX_DOMAIN_SIZE';

/**
 * A dense matrix of numbers encoded in a flat way, row by row.
 * That is matrix[i][j] = entries[i * num_cols + j];
 */
declare type DenseMatrixProto = {
    numRows?: number;
    numCols?: number;
...
declare class Domain {
    ...
    static fromFlatIntervals(intervals: Iterable<ProtoInt64>): Domain;
    static from_flat_intervals(intervals: Iterable<ProtoInt64>): Domain;
    static fromIntervals(intervals: Iterable<Iterable<ProtoInt64>>): Domain;
    static from_intervals(intervals: Iterable<Iterable<ProtoInt64>>): Domain;
    static fromValues(values: Iterable<number>): Domain;
    static from_values(values: Iterable<number>): Domain;
}
 ...
 */
declare type ElementConstraintProto = {
    index?: number;
    /**
     * Legacy field.
     */
...
export declare function export_rcpsp_problem_to_proto(problem: RcpspProblem): RcpspProblemProto;

export declare function exportRcpspProblemToProto(problem: RcpspProblem): RcpspProblemProto;

/**
 * A linear floating point objective: sum coeffs[i] * vars[i] + offset.
 * Note that the variable can only still take integer value.
 */
declare type FloatObjectiveProto = {
    vars?: Array<number>;
    coeffs?: Array<number>;
    offset?: number;
    /**
...
export declare function import_rcpsp_problem_from_proto(proto: RcpspProblemProto): RcpspProblem;

export declare function importRcpspProblemFromProto(proto: RcpspProblemProto): RcpspProblem;

export declare function initRcpsp(): Promise<void>;
 ...
 */
declare type IntegerVariableProto = {
    /**
     * For debug/logging only. Can be empty.
     */
    name?: string;
...
declare class IntervalVar {
    ...
    private readonly isPresent?;
    constructor(model: CpModel, index: number, name: string | undefined, start: LinearExprLike, size: LinearExprLike, end: LinearExprLike, isPresent?: LiteralLike | undefined);
    get model_proto(): CpModelProto;
    startExpr(): LinearExprLike;
    sizeExpr(): LinearExprLike;
    endExpr(): LinearExprLike;
    presenceLiterals(): LiteralLike[];
    toString(): string;
    repr(): string;
}
...
declare class IntVar {
    readonly model: CpModel;
    readonly index: number;
    constructor(model: CpModel, index: number, _name?: string);
    get name(): string;
    get model_proto(): CpModelProto;
    expr(): LinearExpr;
    plus(value: LinearExprLike, coeff?: number): LinearExpr;
    __add__(value: LinearExprLike): LinearExpr;
    minus(value: LinearExprLike): LinearExpr;
    times(coeff: number): LinearExpr;
    __mul__(coeff: number): LinearExpr;
    neg(): LinearExpr;
    abs(): never;
    __abs__(): never;
    ...
    debugString(): string;
    repr(): string;
    eq(value: LinearExprLike): BoundedLinearExpr;
    ne(value: LinearExprLike): BoundedLinearExpr;
    le(value: LinearExprLike): BoundedLinearExpr;
    lt(value: LinearExprLike): BoundedLinearExpr;
    __lt__(value: LinearExprLike): BoundedLinearExpr;
    ge(value: LinearExprLike): BoundedLinearExpr;
    gt(value: LinearExprLike): BoundedLinearExpr;
    __gt__(value: LinearExprLike): BoundedLinearExpr;
}
 ...
 */
declare type InverseConstraintProto = {
...
declare type LinearArgumentProto = {
 ...
 */
declare type LinearConstraintProto = {
    vars?: Array<number>;
    coeffs?: Array<ProtoInt64>;
    /**
     * Same size as vars.
...
declare class LinearExpr {
    ...
    constructor(model: CpModel | null, terms?: ReadonlyMap<number, number>, offset?: number, display?: LinearExprDisplayNode | null);
    static constant(value: number): LinearExpr;
    static sum(values: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): LinearExprLike;
    static Sum(values: Iterable<LinearExprLike> | LinearExprLike, ...rest: LinearExprLike[]): LinearExprLike;
    static weightedSum(values: Iterable<LinearExprLike>, coeffs: Iterable<number>): LinearExprLike;
    static weighted_sum(values: Iterable<LinearExprLike>, coeffs: Iterable<number>): LinearExprLike;
    static WeightedSum(values: Iterable<LinearExprLike>, coeffs: Iterable<number>): LinearExprLike;
    static term(variable: IntVar | NotBoolVar, coeff: number): LinearExpr;
    static Term(variable: IntVar | NotBoolVar, coeff: number): LinearExpr;
    static affine(expression: LinearExprLike, coeff: number, offset: number): LinearExpr;
    ...
    hasFloatingPointTerms(): boolean;
    isInteger(): boolean;
    is_integer(): boolean;
    repr(): string;
    toFloatObjective(maximize?: boolean): {
        vars: number[];
        coeffs: number[];
        offset: number;
        maximize: boolean;
...
declare type LinearExprDisplayNode = {
    kind: 'const';
    value: number;
} | {
    kind: 'var';
    ...
    kind: 'sum';
    values: LinearExprDisplayNode[];
} | {
    kind: 'mul';
    coeff: number;
    value: LinearExprDisplayNode;
} | {
    kind: 'weighted';
    values: LinearExprDisplayNode[];
    coeffs: number[];
 ...
 * size.
 */
declare type LinearExpressionProto = {
    vars?: Array<number>;
    coeffs?: Array<ProtoInt64>;
    offset?: ProtoInt64;
};

declare type LinearExprLike = number | IntVar | NotBoolVar | LinearExpr;

/**
 * A list of variables, without any semantics.
 */
declare type ListOfVariablesProto = {
    vars?: Array<number>;
};

declare type LiteralLike = number | boolean | BoolVar | NotBoolVar;
 ...
 */
declare type NoOverlap2DConstraintProto = {
 ...
 * scheduling.
 */
declare type NoOverlapConstraintProto = {
    intervals?: Array<number>;
};

declare class NotBoolVar {
    readonly variable: IntVar;
    readonly model: CpModel;
    readonly index: number;
    readonly name: string;
    constructor(variable: IntVar);
    get model_proto(): CpModelProto;
    not(): IntVar;
    negated(): IntVar;
    plus(value: LinearExprLike, coeff?: number): LinearExpr;
 ...
 * indices.
 */
declare type PartialVariableAssignment = {
    vars?: Array<number>;
    values?: Array<ProtoInt64>;
};

declare type ProtoInt64 = number | string | {
    low: number;
    high: number;
    unsigned?: boolean;
};

declare type ProtoInt64_2 = number | string | {
    low: number;
    high: number;
    unsigned?: boolean;
};

export declare type RcpspActivityInput = {
    name?: string;
    duration: number;
...
export declare class RcpspModelBuilder {
    private readonly name;
    private readonly resourceNames;
    private readonly resources;
    private readonly activities;
    constructor(name?: string);
    addResource(input: RcpspResourceInput): this;
    add_resource(input: RcpspResourceInput): this;
    addActivity(input: RcpspActivityInput): this;
    add_activity(input: RcpspActivityInput): this;
    build(): RcpspProblem;
}

export declare class RcpspParser {
    ...
    problem(): RcpspProblemProto;
}

export declare class RcpspProblem {
    private readonly problem;
    constructor(problem?: RcpspProblemProto);
    static fromProto(proto: RcpspProblemProto): RcpspProblem;
    static from_proto(proto: RcpspProblemProto): RcpspProblem;
    static fromPsplib(text: string): RcpspProblem;
    static from_psplib(text: string): RcpspProblem;
    get name(): string;
    get resources(): RcpspResourceProto[];
    get tasks(): RcpspTaskProto[];
    get horizon(): number;
    exportModelAsProto(): RcpspProblemProto;
    export_model_as_proto(): RcpspProblemProto;
    toCpSatModel(): CpModel;
    to_cp_sat_model(): CpModel;
    solve(params?: SatParameters): Promise<RcpspSolveResult>;
}

export declare type RcpspProblemProto = {
...
export declare type RcpspRecipeProto = {
    duration?: number;
    demands?: number[];
    resources?: number[];
};

export declare type RcpspResourceInput = {
    name: string;
    capacity: number;
    renewable?: boolean;
};

export declare type RcpspResourceProto = {
    maxCapacity?: number;
    max_capacity?: number;
    minCapacity?: number;
    min_capacity?: number;
...
export declare type RcpspScheduleTask = {
    id: number;
    name: string;
    start: number;
    end: number;
...
export declare type RcpspSolveResult = {
    status: CpSolverStatus | CpSolverStatus_Name;
    statusName: string;
...
export declare type RcpspTaskProto = {
    name?: string;
    successors?: number[];
 ...
 */
declare type ReservoirConstraintProto = {
    minLevel?: ProtoInt64;
    maxLevel?: ProtoInt64;
 ...
 */
declare type RoutesConstraintProto = {
    tails?: Array<number>;
    heads?: Array<number>;
    literals?: Array<number>;
    /**
 ...
 */
declare type RoutesConstraintProto_NodeExpressions = {
    /**
...
declare type SatParameters = {
     ...
     * @default 0
     */
    maxNumberOfConflicts?: ProtoInt64_2;
    /**
     * kint64max
     ...
     * @default 100000000
     */
    presolveInclusionWorkLimit?: ProtoInt64_2;
    /**
     ...
     * @default 64
     */
    shavingSearchThreshold?: ProtoInt64_2;
    /**
     ...
     * @default 100
     */
    pseudoCostReliabilityThreshold?: ProtoInt64_2;
    /**
     ...
     * @default 0
     */
    searchRandomVariablePoolSize?: ProtoInt64_2;
    /**
 ...
 */
declare enum SatParameters_BinaryMinizationAlgorithm {
    NO_BINARY_MINIMIZATION = 0,
    BINARY_MINIMIZATION_FROM_UIP = 1,
    BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS = 5
}

declare type SatParameters_BinaryMinizationAlgorithm_Name = 'NO_BINARY_MINIMIZATION' | 'BINARY_MINIMIZATION_FROM_UIP' | 'BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS';
 ...
 */
declare enum SatParameters_ClauseOrdering {
    /**
...
declare type SatParameters_ClauseOrdering_Name = 'CLAUSE_ACTIVITY' | 'CLAUSE_LBD';
 ...
 */
declare enum SatParameters_ConflictMinimizationAlgorithm {
    NONE = 0,
    SIMPLE = 1,
    RECURSIVE = 2
}

declare type SatParameters_ConflictMinimizationAlgorithm_Name = 'NONE' | 'SIMPLE' | 'RECURSIVE';

/**
 * Rounding method to use for feasibility pump.
 */
declare enum SatParameters_FPRoundingMethod {
    /**
...
declare type SatParameters_FPRoundingMethod_Name = 'NEAREST_INTEGER' | 'LOCK_BASED' | 'ACTIVE_LOCK_BASED' | 'PROPAGATION_ASSISTED';

/**
 * In what order do we add the assumptions in a core-based max-sat algorithm
 */
declare enum SatParameters_MaxSatAssumptionOrder {
    DEFAULT_ASSUMPTION_ORDER = 0,
    ORDER_ASSUMPTION_BY_DEPTH = 1,
    ORDER_ASSUMPTION_BY_WEIGHT = 2
}

declare type SatParameters_MaxSatAssumptionOrder_Name = 'DEFAULT_ASSUMPTION_ORDER' | 'ORDER_ASSUMPTION_BY_DEPTH' | 'ORDER_ASSUMPTION_BY_WEIGHT';

/**
 * What stratification algorithm we use in the presence of weight.
 */
declare enum SatParameters_MaxSatStratificationAlgorithm {
    /**
...
declare type SatParameters_MaxSatStratificationAlgorithm_Name = 'STRATIFICATION_NONE' | 'STRATIFICATION_DESCENT' | 'STRATIFICATION_ASCENT';
 ...
 */
declare enum SatParameters_Polarity {
    POLARITY_TRUE = 0,
    POLARITY_FALSE = 1,
    POLARITY_RANDOM = 2
}

declare type SatParameters_Polarity_Name = 'POLARITY_TRUE' | 'POLARITY_FALSE' | 'POLARITY_RANDOM';
 ...
 */
declare enum SatParameters_RestartAlgorithm {
    NO_RESTART = 0,
    /**
...
declare type SatParameters_RestartAlgorithm_Name = 'NO_RESTART' | 'LUBY_RESTART' | 'DL_MOVING_AVERAGE_RESTART' | 'LBD_MOVING_AVERAGE_RESTART' | 'FIXED_RESTART';

/**
 * The search branching will be used to decide how to branch on unfixed nodes.
 */
declare enum SatParameters_SearchBranching {
    /**
...
declare type SatParameters_SearchBranching_Name = 'AUTOMATIC_SEARCH' | 'FIXED_SEARCH' | 'PORTFOLIO_SEARCH' | 'LP_SEARCH' | 'PSEUDO_COST_SEARCH' | 'PORTFOLIO_WITH_QUICK_RESTART_SEARCH' | 'HINT_SEARCH' | 'PARTIAL_FIXED_SEARCH' | 'RANDOMIZED_SEARCH';

declare enum SatParameters_SharedTreeSplitStrategy {
    /**
...
declare type SatParameters_SharedTreeSplitStrategy_Name = 'SPLIT_STRATEGY_AUTO' | 'SPLIT_STRATEGY_DISCREPANCY' | 'SPLIT_STRATEGY_OBJECTIVE_LB' | 'SPLIT_STRATEGY_BALANCED_TREE' | 'SPLIT_STRATEGY_FIRST_PROPOSAL';
 ...
 */
declare enum SatParameters_VariableOrder {
    IN_ORDER = 0,
    /**
...
declare type SatParameters_VariableOrder_Name = 'IN_ORDER' | 'IN_REVERSE_ORDER' | 'IN_RANDOM_ORDER';
 ...
 */
declare type SparsePermutationProto = {
    /**
 ...
 */
declare type TableConstraintProto = {
    vars?: Array<number>;
    /**
     * Legacy field.
     */
