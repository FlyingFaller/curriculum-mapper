...
[![Package](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml/badge.svg?branch=v0.9.1)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Vite 7 dev Chromium](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Vite%207%20dev%20Chromium&nameFilter=Vite%207%20%2F%20dev%20%2F%20chromium)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Vite 7 dev Firefox](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Vite%207%20dev%20Firefox&nameFilter=Vite%207%20%2F%20dev%20%2F%20firefox)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Vite 7 static Chromium](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Vite%207%20static%20Chromium&nameFilter=Vite%207%20%2F%20static%20%2F%20chromium)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Vite 7 static Firefox](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Vite%207%20static%20Firefox&nameFilter=Vite%207%20%2F%20static%20%2F%20firefox)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Webpack 5 dev Chromium](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Webpack%205%20dev%20Chromium&nameFilter=Webpack%205%20%2F%20dev%20%2F%20chromium)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Webpack 5 dev Firefox](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Webpack%205%20dev%20Firefox&nameFilter=Webpack%205%20%2F%20dev%20%2F%20firefox)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Webpack 5 static Chromium](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Webpack%205%20static%20Chromium&nameFilter=Webpack%205%20%2F%20static%20%2F%20chromium)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Webpack 5 static Firefox](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Webpack%205%20static%20Firefox&nameFilter=Webpack%205%20%2F%20static%20%2F%20firefox)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Rollup 4 static Chromium](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Rollup%204%20static%20Chromium&nameFilter=Rollup%204%20%2F%20static%20%2F%20chromium)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Rollup 4 static Firefox](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Rollup%204%20static%20Firefox&nameFilter=Rollup%204%20%2F%20static%20%2F%20firefox)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Node 24.12.0](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Node%2024.12.0&nameFilter=Node%2024.12.0%20%2F%20solve)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Deno 2.8.1](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Deno%202.8.1&nameFilter=Deno%202.8.1%20%2F%20solve)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
[![Bun 1.3.14](https://img.shields.io/github/check-runs/Axelwickm/or-tools-wasm/v0.9.1?label=Bun%201.3.14&nameFilter=Bun%201.3.14%20%2F%20solve)](https://github.com/Axelwickm/or-tools-wasm/actions/workflows/package.yml?query=ref%3Av0.9.1)
...
<p>
  <img src="https://raw.githubusercontent.com/Axelwickm/or-tools-wasm/v0.9.1/docs/media/factory_floor.gif" alt="Factory floor optimization in PragmaPlanner" height="180">
  <img src="https://raw.githubusercontent.com/Axelwickm/or-tools-wasm/v0.9.1/docs/media/sudoku.gif" alt="Sudoku optimization example in PragmaPlanner" height="180">
</p>
<p>
  <img src="https://raw.githubusercontent.com/Axelwickm/or-tools-wasm/v0.9.1/docs/media/network_design.gif" alt="Network design optimization in PragmaPlanner" height="160">
  <img src="https://raw.githubusercontent.com/Axelwickm/or-tools-wasm/v0.9.1/docs/media/vrp.gif" alt="Vehicle routing optimization in PragmaPlanner" height="160">
  <img src="https://raw.githubusercontent.com/Axelwickm/or-tools-wasm/v0.9.1/docs/media/steel_mill_slab.png" alt="Steel mill slab optimization in PragmaPlanner" height="160">
</p>
...
See [docs/api.md](https://github.com/Axelwickm/or-tools-wasm/blob/v0.9.1/docs/api.md) for the full TypeScript API reference.

## Benchmarking

See [benchmarking/](https://github.com/Axelwickm/or-tools-wasm/tree/v0.9.1/benchmarking).
...
See [docs/bundlers.md](https://github.com/Axelwickm/or-tools-wasm/blob/v0.9.1/docs/bundlers.md) for Vite, Webpack, and Rollup setup.
